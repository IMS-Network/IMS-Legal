...
$to = "legal@ims-network.net";														// To Address
$toAlt = "";												// Additional Recipients
$from = "legal@ims-network.net";													// From Address
$fromName = "IMS - Legal";											// From Name
...
$autorespondSubjectPrefix = "Message From IMS - Legal 🧾";			// Autorespond Form Subject Prefix
