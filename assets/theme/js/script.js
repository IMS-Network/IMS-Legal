...
$jscomp.polyfill("Array.from", function(b) {
    return b ? b : function(b, d, q) {
        ...
        if ("function" == typeof n) {
            ...
            for (n = b.length, r = 0; r < n; r++) h.push(d.call(q, b[r], r));
        return h
    }
}, "es6", "es3");
...
! function() {
    ...
    if (!document.getElementById("top-1")) {
        ...
        a.id = "top-1";
        a.style = "display: none";
        a.innerHTML = '<a href="https://mobiri.se/a7">Free Web Page Creation</a> Mobirise v5.6.11 <a href="https://mobiri.se/ab">Wordpress Alternative</a>';
